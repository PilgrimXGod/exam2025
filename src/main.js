...
window.onload = () => {
    ...
    function animate() {
        ...
        simulationTime += 0.02; // Час йде завжди для плавних анімацій
        controls.update();
        ...
        if (simulationActive) {
            handleSimulation(); // Логіка симуляції викликається тільки, якщо вона активна
        }
    ...
    async function handleSimulation() {
        simulationTime += 0.05; // Змінив: час для симуляції йде окремо
